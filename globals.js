var GLOBAL_DATA = {
	...
	PROJECTS: {
		GRID: {
			pictures: [
				{
					url: '/art-gallery/img/Gallery/GRID/img1.jpg',
					name: 'Error',
					info: '70x90 acrylic on canvas 2017' 
				},
				{
					url: '/art-gallery/img/Gallery/GRID/img2.jpg',
					name: 'Hole',
					info: '60x80 acrylic on canvas 2017' 
				},
				{
					url: '/art-gallery/img/Gallery/GRID/img3.jpg',
					name: 'Frame',
					info: '60x80 acrylic on canvas 2017' 
				},
				{
					url: '/art-gallery/img/Gallery/GRID/img4.jpg',
					name: 'Сoordinate',
					info: '60x70 acrylic on canvas 2017' 
				},
				{
					url: '/art-gallery/img/Gallery/GRID/img5.jpg',
					name: 'Line',
					info: '80x60 acrylic on canvas 2017' 
				},
				{
					url: '/art-gallery/img/Gallery/GRID/img6.jpg',
				...
				{
					url: '/art-gallery/img/Gallery/GRID/img8.jpg',
					name: 'Border diptych',
					info: 'left side 60x80 right side 60x80 acrylic on canvas 2017' 
				},
				{
					url: '/art-gallery/img/Gallery/GRID/img9.jpg',
					name: 'Section',
					info: '80x60 acrylic on canvas 2017' 
				},
				{
					url: '/art-gallery/img/Gallery/GRID/img10.jpg',
					name: 'Grid 2',
	...
	EVENTS: [
		...
		{
			name: 'Exhibition',
			date: new Date(2018, 5, 21, 11, 0),
			place: "Lvivs'ka Kavyarnia",
			description: 'Obcaecati aspernatur at delectus asperiores non sapiente iusto ullam necessitatibus mollitia ducimus. Atque aperiam tempora consequuntur animi expedita, est, sunt deleniti ad vero provident obcaecati praesentium minima. Accusamus nisi tempore aut, distinctio eius eaque architecto minima cum debitis necessitatibus quisquam laboriosam explicabo quos eligendi magni doloribus quas dolore hic.',
			poster: 'url(./img/Events/rsz_img2.jpg)'
		},
		{
			name: 'Open Lecture',
			date: new Date(2018, 4, 13, 20, 0),
			place: '"Львiвська кав\'рня", вул.Соборностi, 22',
			description: 'Provident, facere magnam quas magni rerum possimus, reiciendis repellat aspernatur aperiam distinctio, quasi quia ex id consequuntur ut sapiente quae! Quae aut explicabo consequuntur, cum in voluptate perspiciatis!Ab officia reprehenderit sunt distinctio, iste, nostrum mollitia dolor nihil, molestiae odit ad sequi fugit eum tempore nobis praesentium natus aperiam voluptate quos harum possimus odio enim ipsum! Harum, nemo recusandae sint deleniti architecto vel officiis dolore veniam esse iste ipsa corporis dicta fugiat. Itaque quae assumenda doloribus facilis voluptatum fugit minus eveniet debitis incidunt, aut iure provident, ea culpa dolor magnam porro. Natus ducimus nihil esse ipsum earum praesentium, reiciendis aliquam.',
			poster: 'url(./img/Events/rsz_img1.jpg)'
		},
		{
			name: 'Presentation',
			date: new Date(2018, 3, 4, 15, 0),
			place: 'Art Gallery, Poltava',
			description: 'Lorem ipsum dolor sit amet, consectetur adipisicing elit. Autem fugit libero a possimus quidem, placeat, error nemo accusamus voluptatum ullam voluptatem impedit sed ab vero sequi totam perspiciatis odit doloribus at nihil provident! Aut modi quidem enim ipsam veritatis maxime est accusantium eligendi, at. Error fugiat mollitia amet, recusandae doloribus, labore.',
			poster: 'url(./img/Events/rsz_img3.jpg)'
		},
